...
# val example: "$2,51,418.65" -> 251418.65
df['marketcap'] = (
    df['marketcap'].astype(str)
...
threshhold = int(df.shape[1] * 0.7) # 70% of the columns must be non-NA
...
cleaned_file_path = 'data/Crypto_cleaned.csv'
